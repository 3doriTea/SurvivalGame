...
void GameBase::Component::Image::OnLoad(const YAML::Node& _node, const SchemaLoadBundle& _bundle)
{
...
void GameBase::Component::Image::OnSave(YAML::Emitter& _emitter, const SchemaLoadBundle& _bundle)
{
